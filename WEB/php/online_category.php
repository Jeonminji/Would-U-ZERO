<?php
    ...
    if(isset($_GET["main_category"], $_GET["sub_category"])){
...
<html>
  ...
  <div id="wrap">
	...
	<div class="product">
		<?php                           
			$sql = mq("SELECT * FROM online_info WHERE (main_category LIKE '%$main_category%') AND (sub_category LIKE '%$sub_category%') ");
        ...
        <div class="category_name">
            <a><?php echo $main_category;?>&nbsp&nbsp|&nbsp&nbsp<?php echo $sub_category; ?></a>
        </div>

        <?php
			
			//게시물 목록               
			$sql2 = mq("SELECT * FROM online_info WHERE (main_category LIKE '%$main_category%') AND (sub_category LIKE '%$sub_category%') LIMIT $page_start, $list");
			...
			<ul class="pagination">
				<?php
					if ($page <= 1){ } 
						...
						if(isset($unum)){
							echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=1' aria-label='Previous'>처음</a></li>";
						} else {
							echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=1' aria-label='Previous'>처음</a></li>";
						}
					}
					...
					if ($page <= 1){ } 
						...
						$pre = $page - 1;
						if(isset($unum)){
							echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=$pre'>◀&nbsp이전</a></li>";
						} else {
							echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=$pre'>◀&nbsp이전</a></li>";
						}
					}
					...
					for($i = $block_start; $i <= $block_end; $i++){
						if($page == $i){
							...
							if(isset($unum)){
								echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=$i'>$i</a></li>";
							} else {
								echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=$i'>$i</a></li>";
							}
						}
					...
					if($page >= $total_page){ } 
						...
						$next = $page + 1;
						if(isset($unum)){
							echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=$next'>다음&nbsp▶</a></li>";
						} else {
							echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=$next'>다음&nbsp▶</a></li>";
						}
					}
					...
					if($page >= $total_page){ } 
						...
						if(isset($unum)){
							echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=$total_page'>마지막</a>";
						} else {
							echo "<li class='page-item'><a class='page-link' href='online_category.php?main_category=$main_category&sub_category=$sub_category&page=$total_page'>마지막</a>";
						}
					}
